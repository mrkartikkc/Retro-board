...
io.on("connection", (socket) => {
  ...
  socket.on("board:loaded", handleBoardLoaded)
        .on("board:show-results", handleShowBoardResults)
        .on("board:timer-pause", handleBoardTimerPause)
        .on("board:timer-start", handleBoardTimerStart)
        .on("board:timer-stop", handleBoardTimerStop)
  ...
  socket.on("card:created", handleCardCreated)
        ...
        .on("card:starred", handleCardStarred)
